  ...
  <div class="container py-5">
    ...
    <div class="row g-4 align-items-center">
          ...
          <div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
            <div class="feature-item">
              ...
              <div class="ms-4">
                ...
                <p class="mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur, in illum aperiam
                  ullam magni eligendi?</p>
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-12 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
        <img src="static/img/features-img.png" class="img-fluid w-100" style="object-fit: cover;" alt="Img">
      </div>
      <div class="col-xl-4">
        <div class="row gy-4 gx-0">
          <div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
